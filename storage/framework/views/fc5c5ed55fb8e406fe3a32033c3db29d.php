        ...
        <section class="uk-section" id="section">
            <div class="uk-container">
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="uk-activities uk-grid-collapse uk-margin-medium-bottom" uk-grid uk-height-match="target: .uk-same-height;">
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tapowan\resources\views/themes/default/posttypeTemplate-room-list.blade.php ENDPATH**/ ?>