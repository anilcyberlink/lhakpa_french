                            ...
                            <tbody>
                                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="id<?php echo e($row->id); ?>">
                                        ...
                                        <td>
                                            <?php if(Request::segment(2) == 'room' || Request::segment(2) == 'dining' || (Request::segment(2) == 'about-us' && $row->id != 119)
                                            ): ?>
                                                <a href="<?php echo e(route('admin.multiplephoto', $row->id)); ?>" title="Photo">
                                                    <i class="fa fa-file-image-o fa fa-2x" aria-hidden="true"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if((Request::segment(2) == 'about-us' && $row->id == 119)
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ukeshcom/demo1/resources/views/admin/posts/index.blade.php ENDPATH**/ ?>