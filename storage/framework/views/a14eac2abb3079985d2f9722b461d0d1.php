    ...
    <?php if($posts->count()>0 && $posts[0]): ?>
        <section class="uk-section">
            <div class="uk-container">
                ...
                <ul class=" uk-child-width-1-4@m uk-child-width-1-2 uk-grid-medium uk-grid-match uk-flex uk-flex-center" uk-grid>
                    <!--  -->
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ukeshcom/demo1/resources/views/themes/default/posttypeTemplate-services.blade.php ENDPATH**/ ?>