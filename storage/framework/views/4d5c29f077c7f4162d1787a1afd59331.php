        ...
        <div class="uk-container">
            <div class="uk-flex uk-flex-middle" uk-grid>
                ...
                <?php if($data->associated_title): ?>
                    <div class="uk-width-auto@m uk-banner-font uk-flex">
                        <h3 class="uk-price">Price: NRS. <?php echo e($data->associated_title); ?></h3>
                        <a href="<?php echo e(route('book_now', $data->uri)); ?>" class="uk-btn uk-btn-primary uk-margin-small-left uk-margin-bottom">Book Now</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="uk-grid">
                 <?php if($data->features->count()>0): ?>
                    <div class="uk-width-1-3@m">
                        <div class="light-bg uk-padding" uk-sticky="offset: 100; end:true;" style="z-index:100;">
                ...
                <div class="uk-width-2-3@m">
                    <div>
                         <h3 class="uk-primary uk-text-uppercase">OUR FEATURES</h3>
                    ...
                    <div class="uk-width-1-1@m">
                        ...
                        <!--<?php if($data->associated_title): ?>-->
                        <!--    <div>-->
                        <!--        <a href="<?php echo e(route('book_now', $data->uri)); ?>" class="uk-btn uk-btn-primary  uk-margin-top">Book Now</a>-->
                        <!--    </div>-->
                        <!--<?php endif; ?>-->
                    </div>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ukeshcom/demo1/resources/views/themes/default/template-room-detail.blade.php ENDPATH**/ ?>