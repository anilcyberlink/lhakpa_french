            ...
            <div class="uk-width-3-4@m">
                ...
                <div class="uk-margin-bottom uk-inline">
                    <div class="uk-position-top-right uk-overlay uk-flex uk-flex-right">
                        <a href="<?php echo e(route('delete-wishlist',$row->id)); ?>" class="uk-delete-button"><span uk-icon="icon: close; ratio: 0.9"></span></a>
                    </div>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/themes/default/user/wishlist.blade.php ENDPATH**/ ?>