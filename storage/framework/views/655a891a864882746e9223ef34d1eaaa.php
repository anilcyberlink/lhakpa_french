                      ...
                      <table class="table admin-form table-striped dataTable" id="datatable3">
                        ...
                        <?php if(count($inquiry) > 0): ?>
                           ...
                           <tr class="bg-light">
                            ...
                            <td class="">
                              <a href="<?php echo e(route('inquiry.show',$row->id)); ?>"><?php echo e($row->first_name); ?> <?php echo e($row->last_name); ?></a>
                              <br>Address:<?php echo e($row->address); ?>

                            </td>
                            <td class=""><?php echo e(getPostName($row->post_id)); ?></td>                 
                            <td class=""><?php echo e($row->email); ?></td> 
                            <td class=""><textarea><?php echo $row->message; ?></textarea></td> 
                            <td class=""><?php echo e($row->phone); ?></td>
                            <td class="text-left">
                              <form action="<?php echo e(route('inquiry.destroy', $row->id)); ?>" method="POST">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tapowan\resources\views/admin/room-inquiry/index.blade.php ENDPATH**/ ?>