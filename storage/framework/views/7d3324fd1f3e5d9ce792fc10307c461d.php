        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="title" class="col-lg-2 control-label"><?php echo e(($data->post_id == 119) ? 'Name' : 'Title'); ?></label>
                    <div class="col-lg-8">
                ...
                <div class="form-group">
                    <label for="sub_title" class="col-lg-2 control-label"><?php echo e(( $data->post_id == 119) ? 'Position' : 'Sub Title'); ?></label>
                    <div class="col-lg-8">
                        <input type="text" id="sub_title" name="sub_title" class="form-control" value="<?php echo e($data->sub_title); ?>" />
                    </div>
                </div>
                <?php if($data->post_id != 119): ?>
                    <div class="form-group">
                ...
                <div class="form-group">
                    <label for="content" class="col-lg-2 control-label"><?php echo e(( $data->post_id == 119) ? 'Message' : 'Content'); ?></label>
                    <div class="col-lg-8">
                ...
                <div class="form-group">
                    <label for="thumbnail" class="col-lg-2 control-label"><?php echo e($data->post_id == 119 ? 'Profile' : 'Thumbnail'); ?></label>
                    <div class="col-lg-8">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ukeshcom/demo1/resources/views/admin/associated-post/edit.blade.php ENDPATH**/ ?>