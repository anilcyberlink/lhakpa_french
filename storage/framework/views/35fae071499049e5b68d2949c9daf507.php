              ...
              <div class="panel-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-lg-8">
                      <div class="bs-component">
                       <input type="text" id="" name="email_secondary" class="form-control" placeholder="" value="<?php echo e($data->email_secondary); ?>" />
                      </div>
                    </div>
                  </div>
                <!--   <div class="form-group">
 ...
 -->
                ...
                <div class="form-group">
                   ...
                   <!--  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <div class="bs-component">
                        <textarea class="form-control my-editor" id="" name="welcome_text" rows="3"><?php echo e($data->welcome_text); ?></textarea>
                      </div>
                    </div>
                  </div> -->
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crowneimperial/public_html/resources/views/admin/settings/setting.blade.php ENDPATH**/ ?>