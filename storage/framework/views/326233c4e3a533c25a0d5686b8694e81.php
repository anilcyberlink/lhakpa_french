				...
				<table class="table admin-form theme-warning fs13">
						...
						<tbody>
							...
							<tr class="id<?php echo e($row->id); ?>">
								...
								<td class=""><?php echo e(($row->is_footer_menu == 1)?'Yes':'No'); ?></td>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tapowan\resources\views/admin/post-type/index.blade.php ENDPATH**/ ?>