        ...
        <div class="uk-grid-collapse uk-grid" uk-grid="">
            ...
            <div class="uk-grid-item-match uk-flex-middle uk-width-expand@m">
                <div class="uk-panel uk-width-1-1">
                  <div class="uk-card uk-card-default uk-card-large uk-card-body uk-margin-remove-first-child uk-margin uk-width-xlarge" uk-parallax="x: -100,-100; y: 0,150; media: @l;">
                      <h2 class="uk-title uk-h2 text-primary uk-margin-top uk-margin-remove-bottom"><?php echo e($row->post_title); ?></h2>
                        <div class="uk-content uk-panel uk-margin-top f-14">
                           <hr class="uk-margin-medium" uk-parallax="media: @m; x: 100,100;">
                            ...
                            <a href="<?php echo e(route('event-inquiry',$row->uri)); ?>" class="uk-button  uk-button-secondary-outline uk-margin-top">Inquiry Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-grid-margin uk-grid" uk-grid="">
                    ...
                    <div class="uk-width-expand@m ">
                        ...
                        <div class="uk-margin uk-width-large text-white f-14">
                            ...
                            <a href="<?php echo e(route('event-inquiry',$row->uri)); ?>" class="uk-button uk-button-white-outline uk-margin-top">Inquiry Now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="uk-panel uk-width-1-1">
                    <div class="uk-card uk-card-default uk-card-large uk-card-body uk-margin-remove-first-child uk-position-z-index uk-position-relative uk-margin uk-width-xlarge"
                        ...
                        <div class="uk-content uk-panel uk-margin-top f-14">
                            ...
                            <a href="<?php echo e(route('event-inquiry',$row->uri)); ?>" class="uk-button uk-button-secondary uk-margin-top">Inquiry Now</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crowneimperial/public_html/resources/views/themes/default/posttypeTemplate-conference.blade.php ENDPATH**/ ?>