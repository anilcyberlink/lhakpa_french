                    ...
                    <div class="uk-container uk-container-large"
                        ...
                        <div class="uk-grid-collapse uk-grid" uk-grid="">
                            <div class="uk-width-expand@m">
                                <div class="uk-margin uk-text-right uk-media-700">
                            ...
                            <div class="uk-grid-item-match uk-flex-middle uk-width-expand@m">
                                <div class="uk-panel uk-width-1-1">
                                    <div class="uk-card uk-card-default uk-card-large uk-card-body uk-margin-remove-first-child uk-margin uk-width-xlarge"
                                        uk-parallax="x: -24,-24; y: 0,0; media: @l;">
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crowneimperial/public_html/resources/views/themes/default/posttypeTemplate-offers.blade.php ENDPATH**/ ?>