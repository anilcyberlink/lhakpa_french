...
<?php $__env->startSection('content'); ?>
        ...
        <section class="uk-section  refokus-lines about-bg1">
            ...
            <div class="uk-container uk-margin-bottom">
                <div uk-grid>
                    ...
                    <div class="uk-width-2-3@m uk-flex uk-flex-center uk-flex-column" uk-scrollspy="target: img,h2,p,a; cls: uk-animation-slide-top-small; delay: 100; repeat: false;">
    ...
    <!-- room section start -->
    <?php if($roomsPosts): ?>
        <section class="uk-section about-bg2 uk-padding-remove-top">
            <div class="uk-container">
                <div  uk-scrollspy="target: h2,p,a; cls: uk-animation-slide-top-small; delay: 100; repeat: false;">
                    <div class="uk-banner-font uk-width-1-1@m">
                    ...
                    <div class="uk-banner-font uk-width-1-1@m">
                        <div class="uk-grid">
                            ...
                            <div class="uk-width-1-4@m uk-flex uk-flex-middle uk-flex-right uk-visible@m">
                            ...
                            <?php $__currentLoopData = $roomsPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class=" uk-activities uk-grid-collapse" uk-grid uk-height-match="target: .uk-same-height;">
                                    <div class="uk-width-1-3@m uk-flex uk-flex-middle ">
                                        ...
                                        <a href="<?php echo e(url(geturl($row['uri'], $row['page_key']))); ?>" class="uk-inline uk-transition-toggle uk-link-toggle  uk-media-307 uk-same-height" style="overflow:hidden; height:100%">
                ...
                <div class="uk-grid uk-flex uk-flex-middle" uk-scrollspy="target: h2,p,a; cls: uk-animation-slide-top-small; delay: 100; repeat: false;">
                    ...
                    <div class="uk-banner-font uk-width-1-4@m">
                        <div class="uk-grid">
                            ...
                            <!--</div>-->
                            <div class="uk-width-1-1@m uk-flex uk-flex-middle uk-flex-right uk-visible@m">
        ...
        <section class="uk-section primary-bg uk-background-norepeat uk-background-cover uk-background-center-center " data-src="<?php echo e(asset('themes-assets/img/pattern.png')); ?>" uk-img>
            <div class="uk-container uk-container-small">
                <div class="uk-banner-font" uk-scrollspy=" cls: uk-animation-slide-top-small; delay: 100; repeat: false;">
                    <h2 class="uk-margin-remove uk-text-center uk-white center-underline"><?php echo e($review->uid); ?></h2>
                </div>
                <div class=" uk-padding uk-padding-small-top uk-border-rounded uk-padding-remove-bottom">
                                        ...
                                        <div class="uk-width-expand@s">
                                            <div class="uk-testimonial">
                                                <div class="uk-testimonial-body f-18">
                                                    <span style="font-weight:500;"><?php echo $row->post_excerpt; ?></span>
                                                    <h3 class="uk-margin-top uk-white"><?php echo e($row->post_title); ?></h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ukeshcom/demo1/resources/views/themes/default/frontpage.blade.php ENDPATH**/ ?>