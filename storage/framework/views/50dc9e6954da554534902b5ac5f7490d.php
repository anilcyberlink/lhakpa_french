...
<?php $__env->startSection('content'); ?>
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(Request::segment(2) != 'board-of-directors' && Request::segment(2) != 'reviews'): ?>
                    <div class="sid_ mb10">
                        <div class="hd_show_con">
                            <input type="checkbox" name="is_menu" value="<?php echo e($data->is_menu); ?>"
                                <?php echo e($data->is_menu == 1 ? 'checked' : ''); ?> />
                            Is Menu? <br>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tapowan\resources\views/admin/posts/edit.blade.php ENDPATH**/ ?>