          ...
          <tbody>
            ...
            <tr class="id<?php echo e($row->id); ?>">
              ...
              <?php if($row->thumbnail): ?>            
                <img src="<?php echo e(asset(env('PUBLIC_PATH').'uploads/medium/' . $row->thumbnail)); ?>" width="150" />   
                <?php endif; ?>      
                </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tapowan\resources\views/admin/associated-post/index.blade.php ENDPATH**/ ?>