...
<form class="form-horizontal" role="form" action="<?php echo e(url('admin/activity')); ?>" method="post" enctype="multipart/form-data">
  ...
  <div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            <div class="col-lg-12">
                <div class="bs-component">
                    <input type="text" class="form-control" name="category_video" value="<?php echo e(old('category_video')); ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/activities/create.blade.php ENDPATH**/ ?>