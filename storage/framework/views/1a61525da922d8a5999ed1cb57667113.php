		...
		<div class="panel">
			...
			<div class="panel-body"> 				
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<div class="bs-component">
							<input type="text"  name="uri" class="form-control" placeholder="" value="<?php echo e($data->uri); ?>" readonly />
						</div>
					</div>
				</div> 
        <div class="form-group">
					...
					<div class="col-lg-8">
						<div class="bs-component">
							<input type="text" id="sub_title" name="sub_title" class="form-control" placeholder="" value="<?php echo e($data->sub_title); ?>" />
						</div>
					</div>
				</div>  
       <div class="form-group">
					...
					<div class="col-lg-8">
						<div class="bs-component">
							<input type="text"  name="associated_title" class="form-control" placeholder="" value="<?php echo e($data->associated_title); ?>" />
						</div>
					</div>
				</div>
				<div class="form-group">
            ...
            <div class="col-lg-8">
              <div class="bs-component">
                <textarea class="my-editor form-control" id="editor2" name="content" rows="3"> <?php echo e($data->content); ?></textarea>
             </div>
           </div>
          </div> 
			</div>
  ...
  <div class="hd_show_con">
    <div id="xedit-demo">
     <?php if($data->banner): ?>
        ...
        <img src="<?php echo e(asset(env('PUBLIC_PATH').'uploads/original/' . $data->banner )); ?>" width="150" class="responsive" alt="<?php echo e($data->post_type); ?>"/>
        </span><hr>
        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/admin/post-type/edit.blade.php ENDPATH**/ ?>