...
<!--End of Tawk.to Script-->
                        ...
                        <ul class="uk-flex uk-flex-right uk-topnavbar-ul">  
                            ...
                            <li class="border-right">
                                <a href="<?php echo e(route('page.posttype_detail',$contact_us->uri)); ?>">
                                    <i class="fa-solid fa-phone uk-margin-small-right"></i> <?php echo e($setting->phone); ?>
    ...
    <script>
        ...
        <?php /**PATH C:\xampp\htdocs\Lhakpa\resources\views/themes/default/common/header.blade.php ENDPATH**/ ?>