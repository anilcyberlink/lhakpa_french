        ...
        <div class="uk-grid-collapse" uk-grid>
            <div class="uk-grid-item-match uk-width-1-1 uk-width-1-4@m" uk-scrollspy="target: img; cls: uk-animation-slide-top-small; delay: 100; repeat: false;">
                <div class="uk-container">
                        ...
                        <div class="uk-grid-small uk-padding-remove-bottom  uk-margin-top uk-flex uk-flex-center" uk-grid uk-scrollspy="target: a; cls: uk-animation-slide-top-small; delay: 100; repeat: false;">
                            <?php if($setting->facebook_link): ?>
                                <div>
                                    <a href="<?php echo e($setting->facebook_link); ?>" class="uk-social-icon-footer"> <i class="fa fa-facebook"></i> </a>
                                </div>
                            ...
                            <?php if($setting->twitter_link ): ?>
                                <div>
                                    <a href="<?php echo e($setting->twitter_link); ?>" class="uk-social-icon-footer"> <i class="fa-brands fa-tiktok"></i> </a>
                                </div>
                            <?php endif; ?>
                            <?php if($setting->youtube_link): ?>
                                <div>
                ...
                <div class="bg-black uk-tile">
                    <ul class="uk-list uk-list-large uk-width-medium@m uk-margin-auto">
                            ...
                            <li>
                                <a target="_blank" href="">
                                    <div class="uk-flex uk-flex-middle">
                                        <div><span class="uk-margin-small-right" uk-icon="icon: location; ratio:1;" style="width:20px;"></span></div>
                        ...
                        <?php if($setting->email_primary): ?>
                            <li>
                                <a href="mailto:<?php echo e($setting->email_primary); ?>;">
                                    <div class="uk-flex uk-flex-middle">
                                        <div><span class="uk-margin-small-right" uk-icon="icon: mail; ratio:1;" style="width:20px;"></span></div>
            ...
            <div class="uk-container">
                <div class="uk-flex-middle" uk-grid uk-scrollspy="target: li; cls: uk-animation-slide-top-small; delay: 100; repeat: false;">
                    ...
                    <div class="uk-width-auto@m uk-margin-remove">
                        <ul class="uk-grid uk-text-small" uk-grid>
                            <li>Website by Yantra Network Solution Pvt. Ltd.</li>
                        </ul>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH /home/ukeshcom/demo1/resources/views/themes/default/common/footer.blade.php ENDPATH**/ ?>