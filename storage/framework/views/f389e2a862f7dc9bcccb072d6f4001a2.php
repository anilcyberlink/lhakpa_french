        ...
        <div class="uk-container uk-flex uk-flex-center">
            <div class="uk-card uk-card-default uk-padding uk-margin-auto-vertical border" style="padding-bottom:60px; width: 678px; max-width: 100% !important;">
                ...
                <div class="uk-switcher uk-margin">
                    <div>
                        <form class="uk-contact-form" action="<?php echo e(route('password.update')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class=" uk-child-width-1-1@m uk-grid">
                                <div class="uk-margin-small-top">
                                    ...
                                    <div class="uk-form-controls">
                                        <input class="uk-input" id="user_email" placeholder="Enter your valid email address" name="email" value="<?php echo e($email); ?>" readonly required type="email">
                                    </div>
                                </div>
                                <div class="uk-margin-small-top">
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lhakpa/public_html/resources/views/themes/default/update-password.blade.php ENDPATH**/ ?>