        ...
        <div class="uk-container">
            <div class="uk-flex uk-flex-middle" uk-grid>
                <div class="uk-banner-font uk-width-expand@m">
                    ...
                    <span class="uk-primary"><?php echo e($data->post_title); ?></span>
                ...
                <div class="uk-width-auto@m uk-banner-font">
                    <a href="<?php echo e(route('event-inquiry', $data->uri)); ?>" class="uk-btn uk-btn-primary  uk-margin-top">Inquiry Now</a>
                </div>
            </div>
            <?php echo $data->post_content; ?>

            <div class="uk-child-width-1-4@m uk-child-width-1-2 uk-grid">
                <?php if($data->opening_hours): ?>
                    <div>
                        <p class="uk-primary uk-margin-remove"><b>Opening Hours:</b></p>
                        <p class="uk-margin-remove"><?php echo e($data->opening_hours); ?></p>
                    </div>
                <?php endif; ?>
                <?php if($data->occupancy): ?>
                    <div>
                        <p class="uk-primary uk-margin-remove"><b>Occupancy:</b></p>
                        <p class="uk-margin-remove"><?php echo e($data->occupancy); ?> People</p>
                    </div>
                <?php endif; ?>
                <?php if($data->smoking): ?>
                    <div>
                        <p class="uk-primary uk-margin-remove"><b>Smoking :</b></p>
                        <p class="uk-margin-remove"><?php echo e($data->smoking); ?></p>
                    </div>
                <?php endif; ?>
                <?php if($data->wifi): ?>
                    <div>
                        <p class="uk-primary uk-margin-remove"><b>Wifi :</b></p>
                        <p class="uk-margin-remove"><?php echo e($data->wifi); ?></p>
                    </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('themes.default.common.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\tapowan\resources\views/themes/default/template-dinning-detail.blade.php ENDPATH**/ ?>