            ...
            <div class="uk-menu-inner-border bg-white uk-position-relative">
               ...
               <div class="uk-food-menu-content uk-margin-large-top uk-margin-large-bottom uk-padding uk-display-block">
                  ...
                  <div class="uk-width-xlarge uk-text-center uk-margin-auto"> 
                     ...
                     <h1 class="uk-h2 f-w-600 uk-margin-remove text-primary"><?php echo e($post_category->category); ?> <?php echo e($post_category->category_caption); ?></h1>
                     <p class="uk-margin-remove"><?php echo $post_category->category_content; ?><i></i></p>
                  </div>
                     <!--  -->
                     <?php if($data->count()>0): ?>
               ...
               <!--  -->
                 <?php if($data->count()>0): ?>
                  <?php $__currentLoopData = $data->slice(0, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               ...
               <?php endif; ?>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php $__currentLoopData = $data->slice(1, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <?php if($value->page_thumbnail): ?>
               ...
               <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php $__currentLoopData = $data->slice(2, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <?php if($value->page_thumbnail): ?>
               ...
               <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php $__currentLoopData = $data->slice(3, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <?php if($value->page_thumbnail): ?>
               ...
               <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php $__currentLoopData = $data->slice(4, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <?php if($value->page_thumbnail): ?>
               ...
               <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               <?php $__currentLoopData = $data->slice(5, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <?php if($value->page_thumbnail): ?>
...
<?php /**PATH /home/crowneimperial/public_html/resources/views/themes/default/emenu.blade.php ENDPATH**/ ?>