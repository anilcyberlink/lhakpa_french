        ...
        <div class="uk-flex uk-flex-middle uk-flex-center uk-grid-collapse " uk-grid>
            <div class="uk-width-1-1@m">
                <div class="uk-sub-banner-font uk-text-center">
                    <h2 class="uk-secondary uk-margin-large-top">Informations sur le profil</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="uk-container">
        <div class="uk-div-overlay " uk-grid>
            ...
            <div class="uk-width-3-4@m">
                <p class="uk-visible@m uk-white" style="margin:2rem 0px 4rem 0;">Modifiez votre profil ci-dessous:
                </p>
                <div class="uk-container">
                            ...
                            <div class="uk-width-3-4@m uk-flex uk-flex-middle">
                                <div class="uk-child-width-1-2@m uk-grid">
                                    <div class="uk-margin-bottom">
                                        <p class="uk-margin-remove uk-primary">Nom et prénom:</p>
                                        <p class="uk-margin-remove">{{ Auth::user()->name }}</p>
                                    </div>
                                    <div class="uk-margin-bottom">
                                        <p class="uk-margin-remove uk-primary">Adresse:</p>
                                        <p class="uk-margin-remove ">{{ Auth::user()->address }}</p>
                                    </div>
                                    <div class="uk-margin-bottom">
                                        <p class="uk-margin-remove uk-primary">Adresse email:</p>
                                        <p class="uk-margin-remove">{{ Auth::user()->email }}</p>
                                    </div>
                                    <div class="uk-margin-bottom">
                                        <p class="uk-margin-remove uk-primary">Numéro de téléphone:</p>
                    ...
                    <form method="post" action="{{ route('user-profile') }}" enctype="multipart/form-data">
                       @csrf
                        ...
                        <div class=" uk-child-width-1-2@s uk-grid">
                            <div>
                                 <h3 class="uk-primary uk-margin-medium-top">Mettez à jour votre profil</h3>
                            </div>
                            <div class="uk-margin-medium-top uk-text-left uk-text-right@m">
                                @if(session()->has('intended_trip'))
                                <a href="{{ url('page/' . tripurl(session('intended_trip'))) }}" class="uk-btn uk-btn-secondary" >Continuer la réservation <span uk-icon="chevron-right"></span></a>
                                @endif
                            </div>
                        </div>
                        <hr>
                        <div class="uk-grid">
                            <div class="uk-width-1-1@s uk-margin-small-top">
                                <div class="uk-flex uk-flex-column" uk-form-custom>
                                    <label class="uk-form-label " for="image">Image de profil:</label>
                                    <div class="uk-flex uk-flex-middle">
                                        <input type="file" aria-label="Custom controls" name="imageProfile">
                                        <button class="uk-button uk-button-default uk-margin-small-right" type="button" tabindex="-1" style="border: 1px solid #333 !important;">Changer de profil</button>
                            ...
                            <div class="uk-width-1-1@s uk-margin-small-top">
                                <label class="uk-form-label " for="Category">Votre façon de voyager:</label>
                        ...
                        <div class="uk-width-1-1 uk-margin-medium-top">
                            <button type="submit" class="uk-btn uk-btn-secondary">Mettre à jour le profil</button>
                        </div>
                    </form>
                </div>
            </div>
