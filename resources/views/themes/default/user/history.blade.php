        ...
        <div class="uk-flex uk-flex-middle uk-flex-center uk-grid-collapse " uk-grid>
            <div class="uk-width-1-1@m">
                <div class="uk-sub-banner-font uk-text-center">
                    <h2 class="uk-secondary uk-margin-large-top">Votre historique de voyage</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="uk-container">
        <div class="uk-div-overlay " uk-grid>
            ...
            <div class="uk-width-3-4@m">
                <p class="uk-visible@m uk-white" style="margin:2rem 0px 5rem 0;">Voyage que vous avez effectué avec nous :
                </p>
