...
<section
    ...
    uk-height-viewport data-src="https://cyberlinknepal.com/design/lhakpa/assets/img/mountain/mountain6.jpeg" alt=""
    uk-img>
        ...
        <div class="uk-flex uk-flex-middle uk-grid-collapse " uk-grid>
            <div class="uk-width-1-1@m">
                <ul class="uk-breadcrumb">
                    ...
                    <li><span class="uk-secondary">Revoir</span></li>
                </ul>
                <div class="uk-sub-banner-font">
                    <h1>Avis de nos voyageurs</h1>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="uk-width-1-5@m">
                                <div class="uk-text-center">
                                    ...
                                    @if(trip_count($value->user_id) >= 1)
                                        <p class=" uk-margin-top uk-primary"> {{trip_count($value->user_id)}} voyage avec Lhakpa
                                            Treks</p>
                                    @endif
                                </div>
                            </div>
